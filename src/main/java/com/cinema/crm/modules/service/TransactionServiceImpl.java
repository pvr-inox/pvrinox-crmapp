...
public class TransactionServiceImpl implements TransactionService {
	...
	public TransactionServiceImpl(EntityManager entityManager, OrderBookingRepository orderBookingRepository) {
	...
	public ResponseEntity<Object> signleRefund(SingleRefundReq singleRefundReq) {
		WSReturnObj<Object> returnObj = new WSReturnObj<>();
		Optional<OrderBooking> booking = orderBookingRepository.findById(singleRefundReq.getBookingId());
		return ResponseEntity.ok(returnObj);
	}
